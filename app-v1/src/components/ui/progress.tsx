...
const Progress = React.forwardRef<ProgressPrimitive.RootRef, ProgressPrimitive.RootProps & { indicatorClassName?: string }>(({ className, value, indicatorClassName, ...props }, ref) => {
  return (
